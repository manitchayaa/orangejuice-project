    ...
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {certificates?.map((cert) => (
          <Card key={cert.id} className="flex flex-col h-full overflow-hidden p-0 group relative border border-gray-200 dark:border-gray-800">
            {/* Aspect Ratio [1.414] A4 Landscape Ratio with Contain Image */}
            <div className="w-full aspect-[1.414] overflow-hidden bg-gray-50 dark:bg-gray-900 border-b border-gray-150 dark:border-gray-800 relative flex items-center justify-center">
              {cert.image_url ? (
                <img 
                  src={cert.image_url} 
            ...
            <div className="p-4 flex-grow flex flex-col justify-between bg-white dark:bg-[#101018]">
              <div>
