      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects?.map((project) => {
          ...
          return (
            ...
            >
              {project.image_url ? (
                <div className="w-full h-48 overflow-hidden bg-gray-100/40 dark:bg-gray-900/30 relative animate-pulse">
                  <img 
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {selectedProject.github_url && (
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer" 
                      className="inline-flex items-center justify-center w-full px-4 py-3 bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900 text-xs font-extrabold rounded-xl hover:opacity-90 transition-all border border-gray-200 dark:border-gray-700 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
                    >
