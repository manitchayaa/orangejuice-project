...
return (
    <>
      ...
      <div className="max-w-7xl mx-auto flex-col items-center justify-between px-6 py-6 ">

        <div className="flex justify-between px-4 pt-5">
          <h1 className="text-2xl font-bold ">เรื่องมาแรง & ​​ยอดนิยม</h1>
          <a href="/most-popular-planets" className="text-gray-500 hover:underline ">
            ดูทั้งหมด &gt;
          </a>
        </div>
        
        <div className="flex px-4 pt-4 gap-2">
          <button className="bg-gray-200 hover:bg-gray-300 cursor-pointer text-black font-bold px-4 py-2 rounded-full">
            มาแรง
          </button>
          <button className="bg-gray-200 hover:bg-gray-300 cursor-pointer text-black font-bold px-4 py-2 rounded-full ">
            ยอดนิยม
      ...
      <div className="max-w-7xl mx-auto flex-col items-center justify-between px-6 py-6 ">
        ...
        <a href="/most-popular-planets" className="flex items-center justify-center text-gray-500 hover:underline leading-none">
          ดูทั้งหมด &gt;
        </a>
        </div>
